...
namespace WebApplication4.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string Email, string Password, string ReturnUrl)
        {
            ...
            Admin_visoresEntities db = new Admin_visoresEntities();


            var L2EQuery = db.Users.Where(s => s.email == Email);
            Users logged_user = L2EQuery.FirstOrDefault();
            ...
            if (logged_user != null)
            {
                ...
                if (isvalidLogin(logged_user, Password) && logged_user.is_sa == true)
                {
            ...
            else
            {
                ...
                return RedirectToAction("Login", "Account", new { user = Email });
        ...
        private bool isvalidLogin(Users logged_user, string password)
        {
            string encpass = GenerateToken(password);

            string storedpass = logged_user.password;
