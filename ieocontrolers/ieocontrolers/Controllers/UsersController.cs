...
namespace WebApplication4.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,email,password")] Users users)
        {
            if (ModelState.IsValid)
            {

                string pass = GenerateToken(users.password);
                string usertoken = GenerateToken(users.email);
        ...
        private string GenerateToken(string str)
        {
            ...
            {
            new Claim(JwtRegisteredClaimNames.UniqueName, str),
            };
